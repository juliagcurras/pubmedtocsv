...
first 500 rows. Within this table, users can sort data by column, search for 
specific keywords, and using the panel located in the top left region of the table, 
...
These graphs can be found in different overlapping tabs, and to access each of them 
just click the corresponding name of the tab. 
...
Contac information is provided in the bottom of the web page, with access to the 
GitHub repository where any issue can be reported. 
...
The most important tags are identified and its meaning is explicitly mentioned in the 
column names, but for some tags this information is missing. In the following table
you can see all tha tags consired as long as their meaning: 
